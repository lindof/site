    ...
    $.widget('mageworx.optionBase', {
        ...
        collectSelectedData: function collectSelectedData() {
            ...
            var self = this,
                form = this.getFormElement(),
                config = this.options,
                configOptions = $('.super-attribute-select', form),
                options = $(config.optionsSelector, form);

            configOptions.filter('input').each(function (index, element) {
                var $element = $(element),
                    optionId = $element.data('attr-name'),
                    values = $element.val();
                ...
                window.cpSelectedData[optionId] = values;
