...
class ThemeSchedulingAjax extends \Magento\Framework\App\Action\Action
{
    ...
    public function execute() {
        ...
        $block = $this->_viewLayoutFactory->create()->createBlock('Knowband\Spinandwin\Block\Adminhtml\Tab\ScheduledThemes');
