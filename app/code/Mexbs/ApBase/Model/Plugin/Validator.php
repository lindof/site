...
class Validator{
    ...
    public function beforeInitTotals(
		...
		$address->getQuote()->unsExtraMessagesToDisplay();
    ...
    public function aroundInitTotals(
        ...
        $totalInfo = $subject->getRulesItemTotalsInfo();
        $cartFixedRules = $address->getQuote()->getCartFixedRules();
        ...
        $subject->setRulesItemTotalsInfo($totalInfo);
        $address->getQuote()->setCartFixedRules($cartFixedRules);
