...
class FirstNNextMAfterKFixedPriceDiscount extends FirstNNextMAfterKAbstract{

    const SIMPLE_ACTION = 'first_n_next_m_after_k_fixed_price_discount_action';
    const MAX_NUMBER_OF_SEQS = 5;

    protected $type = 'Mexbs\AdditionalPromotions\Model\Rule\Action\Details\FirstNNextMAfterKFixedPriceDiscount';
