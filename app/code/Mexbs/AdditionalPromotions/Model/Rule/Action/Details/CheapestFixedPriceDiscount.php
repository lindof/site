...
class CheapestFixedPriceDiscount extends \Mexbs\ApBase\Model\Rule\Action\Details\GetEachNAbstract{

    const SIMPLE_ACTION = 'cheapest_fixed_price_discount_action';
    protected $type = 'Mexbs\AdditionalPromotions\Model\Rule\Action\Details\CheapestFixedPriceDiscount';
    ...
    public function asHtmlRecursive()
    {
        ...
        $getEachNHtml .=  __(
                "Get the %1th %2 item (matching the same conditions), for %3%4",
