...
class CheapestPercentDiscount extends \Mexbs\ApBase\Model\Rule\Action\Details\GetEachNAbstract{

    const SIMPLE_ACTION = 'cheapest_percent_discount_action';
    protected $type = 'Mexbs\AdditionalPromotions\Model\Rule\Action\Details\CheapestPercentDiscount';
    ...
    public function asHtmlRecursive()
    {
        ...
        $getEachNHtml .=  __(
                "Get the %1th %2 item (matching the same conditions), with %3% discount",
