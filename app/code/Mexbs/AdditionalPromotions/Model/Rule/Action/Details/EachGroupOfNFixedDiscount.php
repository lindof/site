...
class EachGroupOfNFixedDiscount extends ProductsSetTotalDiscountAbstract{

    const SIMPLE_ACTION = 'each_group_of_n_fixed_discount_action';
    protected $type = 'Mexbs\AdditionalPromotions\Model\Rule\Action\Details\EachGroupOfNFixedDiscount';
