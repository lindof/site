...
class Form extends Generic
{
    ...
    protected function _prepareForm()
    {
        ...
        foreach ($supplierShippingMethods as $method) {
            ...
            $isStorePickupAvailable = (int)$method->getData('store_pickup');
            ...
            if ($isFlatRateAvailable === 1) {
                ...
                $selectedMethod = 3;
            } elseif ($isStorePickupAvailable === 1) {
                $selectedMethod = 4;
            }
            ...
            $fieldset->addField(
                'store_address_' . $method->getData('id'),
                'text',
                array(
                    'label' => __('Store Address'),
                    'name' => 'store_address['. $method->getData('id') . ']',
                    'value' => $method->getData('store_address'),
                    'data-form-part' => 'customer_form'
                )
            );
