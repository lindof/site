...
{
    const XML_PATH_EMAIL_TEMPLATE_FIELD  = 'configuration_marketplace/presentation/shipping_company_template';
    ...
    */
    ...
    public function ShippingCompany_MailSendMethod($emailTemplateVariables,$senderInfo,$receiverInfo)
    {
        try {
