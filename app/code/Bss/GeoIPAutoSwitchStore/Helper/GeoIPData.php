...
class GeoIPData
{
    ...
    /**
     * @var \Magento\Framework\Session\SidResolverFactory
     */
    public $sidResolver;
     ...
     * @param \Magento\Framework\Session\SidResolverFactory $sidResolver
    ...
    public function __construct(
        \Magento\Framework\Session\SidResolverFactory $sidResolver,
     ...
     * @return mixed
     */
    public function isLargerVersion222()
    {
     ...
     * @return mixed
     */
    public function isLargerVersion225()
    {
        $version = $this->productMetadata->getVersion();
    ...
    /**
     * @return \Magento\Framework\Url\Encoder
     */
    ...
    /**
     * @return \Magento\Framework\Session\SidResolverFactory
     */
    public function getSIDResolver()
    {
        return $this->sidResolver->create();
    }
